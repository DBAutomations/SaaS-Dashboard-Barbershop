  ...
  return (
    ...
    >
      <div className="flex items-center gap-3 mb-6">
        ...
        <h3 className="text-lg font-semibold text-card-foreground">Cost Savings Analysis</h3>
      </div>
      ...
      <div className="space-y-6">
        ...
        <div className="text-center p-4 bg-gradient-to-br from-accent/10 to-accent/5 rounded-xl border border-accent/20">
          <div className="metric-large text-accent">${monthlySavings.toLocaleString()}</div>
        ...
        <div className="border-t border-border pt-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm font-medium text-card-foreground">Yearly Projection</span>
            </div>
            <span className="font-bold text-success">${yearlyProjection.toLocaleString()}</span>
          </div>
        ...
        <div className="bg-primary/5 rounded-lg p-3">
          <h4 className="text-sm font-medium text-card-foreground mb-2">Additional Benefits</h4>
